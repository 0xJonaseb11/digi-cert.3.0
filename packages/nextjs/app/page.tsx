...
// Custom RainbowKit theme to match CertifyChain's design
...
// Custom CSS for the Connect Wallet button
const customStyles = `
  ...
  .rainbow-modal .wallet-button:hover {
    transform: scale(1.02);
    box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.1);
  }
  .rainbow-modal .wallet-button:active {
    transform: scale(0.98);
  }
  ...
  .rainbow-modal .close-button {
    background: #E2E8F0;
    color: #64748B;
    border-radius: 0.5rem;
    padding: 0.5rem;
  }
  .rainbow-modal .close-button:hover {
    background: #D1D5DB;
  }
`;
    ...
    <RainbowKitProvider theme={customTheme}>
      ...
      <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50">
          ...
          <div className="container mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <nav className="hidden md:flex items-center space-x-8">
                ...
                <a href="#blockchain" className="text-slate-700 hover:text-blue-600 transition-colors">
                  Blockchain
                </a>
                <a href="#solutions" className="text-slate-700 hover:text-blue-600 transition-colors">
                  Solutions
                </a>
                <a href="#nft" className="text-slate-700 hover:text-blue-600 transition-colors">
                  NFT Certs
                </a>
          ...
          <div className="container mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
              {[
                ...
                <Card
                  key={index}
                  className="hover:shadow-lg transition-all duration-300 border-slate-200 bg-white/80 backdrop-blur text-center"
                >
                  <CardHeader>
                    <div
                  ...
                  <CardContent>
                    <CardDescription className="text-slate-600">{network.desc}</CardDescription>
                  </CardContent>
                </Card>
              ))}
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              <div>
                ...
                <p className="text-slate-600 mb-6">
                  Our platform supports multiple blockchain networks, allowing you to choose the best network for your
                  needs while maintaining seamless interoperability across chains.
                </p>
        ...
        <section id="features" className="py-20">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4">Advanced Blockchain Features</h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
                Comprehensive blockchain-powered certification platform with cutting-edge features for maximum security
                and efficiency.
              </p>
            </div>
          ...
          <div className="container mx-auto px-6">
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-6">Next-Generation NFT Certificates</h2>
                <p className="text-xl text-slate-600 mb-8">
                  Transform your certificates into unique, collectible NFTs with built-in verification, ownership
                  tracking, and marketplace integration.
                </p>
                ...
                <div className="grid md:grid-cols-2 gap-6 mb-8">
                  ...
                  <div className="bg-white/80 backdrop-blur rounded-lg p-6 border border-slate-200">
                    ...
                    <p className="text-slate-600 text-sm">
                      Compatible with major NFT marketplaces for trading and showcase.
                    </p>
                  </div>
                </div>
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                ...
                <Card key={index} className="hover:shadow-lg transition-all duration-300 border-slate-200 bg-white">
                  ...
                  <CardContent>
                    <CardDescription className="text-slate-600 text-center">{solution.description}</CardDescription>
                  </CardContent>
                </Card>
              ))}
            </div>
        ...
        <section className="py-20 bg-gradient-to-b from-slate-50 to-white">
          <div className="container mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-3xl lg:text-4xl font-bold text-slate-900 mb-4">Advanced Technology Stack</h2>
              <p className="text-xl text-slate-600 max-w-3xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
              {[
                ...
                <Card
                  key={index}
                  className="hover:shadow-lg transition-all duration-300 border-slate-200 bg-white/80 backdrop-blur text-center group"
                >
                  <CardHeader>
                    <div
              ...
              <Accordion type="single" collapsible>
                <AccordionItem value="item-1">
                  ...
                  <AccordionContent className="text-slate-600">
                    Each certificate is cryptographically signed and stored on an immutable blockchain ledger. This
                    creates a permanent, tamper-proof record that can be instantly verified without relying on the
                ...
                <AccordionItem value="item-2">
                  ...
                  <AccordionContent className="text-slate-600">
                    We support all major wallets including MetaMask, WalletConnect, Coinbase Wallet, and hardware
                    wallets like Ledger and Trezor. Enterprise customers can also use custodial wallet solutions.
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-3">
                  <AccordionTrigger className="text-slate-900">Can certificates be converted to NFTs?</AccordionTrigger>
                  <AccordionContent className="text-slate-600">
                    Yes! Any certificate can be minted as an NFT with unique metadata, making it collectible and
                    tradeable on NFT marketplaces while maintaining its verification capabilities.
                  </AccordionContent>
                </AccordionItem>

                <AccordionItem value="item-4">
                  <AccordionTrigger className="text-slate-900">What are the transaction costs?</AccordionTrigger>
                  <AccordionContent className="text-slate-600">
                    We support multiple blockchain networks with varying costs. Ethereum certificates cost $2-5 per
                    transaction, while Polygon certificates cost under $0.01. We also offer gasless solutions for
                ...
                <AccordionItem value="item-5">
                  ...
                  <AccordionContent className="text-slate-600">
                    You can verify certificates using our web portal, QR code scanner, or API without needing a wallet.
                    However, connecting a wallet provides additional features like certificate ownership and NFT
                    functionality.
                  </AccordionContent>
                </AccordionItem>
                ...
                <AccordionItem value="item-6">
                  ...
                  <AccordionContent className="text-slate-600">
                    Yes, we're fully compliant with GDPR, CCPA, and other major data protection regulations. We use
                    privacy-preserving blockchain techniques that don't store personal data on-chain.
                  </AccordionContent>
                </AccordionItem>
              </Accordion>
            </div>
        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
          ...
          <div className="container mx-auto px-6 text-center relative">
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join hundreds of organizations already using CertifyChain to issue secure, verifiable digital certificates
        ...
        <footer className="py-16 bg-slate-900 text-white">
          <div className="container mx-auto px-6">
            ...
            <div className="flex flex-col md:flex-row justify-between items-center text-slate-400">
              <p>© 2025 CertifyChain. All rights reserved.</p>
