...
const faqList = [
  {
    icon: <ShieldCheck className="w-5 h-5 text-blue-500 mr-2" />,
  ...
  {
    icon: <FileText className="w-5 h-5 text-blue-500 mr-2" />,
      ...
      <div className="w-full">
        <div className="w-full max-w-none bg-gradient-to-r from-[#23272f] to-[#e0f2fe] shadow-xl rounded-2xl p-8 border-2 border-blue-100">
          ...
          <div className="mt-8 flex flex-col items-center">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-blue-50 border border-blue-200 text-blue-700 font-semibold shadow-sm">
