...
export interface FinesEngineInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "imposeFineERC20",
...
export interface FinesEngine extends BaseContract {
  ...
  imposeFineERC20: TypedContractMethod<
    [_enterprise: AddressLike, _token: AddressLike, _tier: string],
    [void],
    "nonpayable"
  >;
  ...
  getFunction(
    nameOrSignature: "imposeFineERC20"
  ): TypedContractMethod<
    [_enterprise: AddressLike, _token: AddressLike, _tier: string],
    [void],
    "nonpayable"
